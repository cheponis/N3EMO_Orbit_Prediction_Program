...
There is a sample "w3vc.sit" - 'site' file giving coordinates & elevation to the orbit program.

A sample 2-line element file and a kepler.dat file can be used to test your compiles.
